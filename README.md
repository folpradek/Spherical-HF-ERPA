...
To run the code, you have to download it, and have installed Julia [1] (_v9.4 or newer should be sufficient, I suggest you do not use >v1.10. due to performance drop caused by the way compiler handles dictionaries used for interaction matrix element lookups, the lastest Long-Term Stable release is the best to use_). Furthermore, the solver requires these Julia packages:
  - LinearAlgebra
  - DelimitedFiles
  - BenchmarkTools
  - Printf
