function V2B_Res_Density(Params::Parameters,Orb::Vector{NOrb},Orb_NN::NNOrb,Orb_NNN::NNNOrb,VNN::NNInt,VNNN::Array{Vector{Vector{Float32}},4},Rho::pnMatrix)
    # Read parameters ...
...
function V2B_Res(Params::Parameters,Orb::Vector{NOrb},Orb_NN::NNOrb,VNN::NNInt,U::pnMatrix)
...
function V2B_Res_Import(Params::Parameters,Orb::Vector{NOrb})
    # Read parameters ...
