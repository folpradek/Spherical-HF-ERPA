function Transition_Operators_Ini(Params::Parameters,Orb::Vector{NOrb})
    # Read parameters
...
function Transition_Operators_Transform(Params::Parameters,TrOp::TranOper,Orb::Vector{NOrb},U::pnMatrix)
