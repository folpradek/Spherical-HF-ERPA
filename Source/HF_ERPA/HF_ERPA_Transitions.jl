function HF_ERPA_rM(Params::Parameters,N_nu::Matrix{Int64},Orb_Phonon::Matrix{Vector{Int64}},Phonon::Vector{PhState},Particle::pnSVector,Hole::pnSVector,X_RPA::Matrix{Matrix{ComplexF64}},Y_RPA::Matrix{Matrix{ComplexF64}},TrOp::TranOper,Rho::pnMatrix)
...
function HF_ERPA_rB(Params::Parameters,N_nu::Matrix{Int64},rM::ReducedMultipole)
    # Read parameters ...
    Orthogon = Params.Calc.Ortho
...
function HF_ERPA_Transition_Densities_Export(Params::Parameters,Orb::Vector{NOrb},N_nu::Matrix{Int64},Orb_Phonon::Matrix{Vector{Int64}},Phonon::Vector{PhState},Particle::pnSVector,Hole::pnSVector,X_RPA::Matrix{Matrix{ComplexF64}},Y_RPA::Matrix{Matrix{ComplexF64}},TrOp::TranOper)
    # Read parameters ...
    A = Params.Calc.A
    Z = Params.Calc.Z
    ...
    pU_Import = Output_File * "/Bin/pU_HF.bin"
    ...
    nU_Import = Output_File * "/Bin/nU_HF.bin"
