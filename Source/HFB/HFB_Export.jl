...
function HFB_export(Params::Parameters,Orb_NN::NNOrb,C::pnMatrix,U::pnMatrix,V::pnMatrix,H_N::qpH1B,H_NN::qpH2B)
    ...
    # Export HFB 1-body Hamiltonian H_N ... qpH11 ...
    H1B_Export = "IO/" * Output_File * "/Bin/qpH1B11.bin"
    ...
    # Export HFB 1-body Hamiltonian H_N ... qpH20 ...
    H1B_Export = "IO/" * Output_File * "/Bin/qpH1B20.bin"
    open(H1B_Export, "w") do Export_File
        @inbounds for a in 1:a_max
            @inbounds for b in 1:a
