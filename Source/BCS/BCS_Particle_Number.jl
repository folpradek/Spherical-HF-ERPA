function BCS_Particle_Number(Params::Parameters,V::pnVector,Orb::Vector{NOrb})
...
function BCS_Particle_Number_Dispersion(Params::Parameters,U::pnVector,V::pnVector,Orb::Vector{NOrb})
    # Read parameters ...
    N_max = Params.Calc.Nmax
    a_max = div((N_max + 1)*(N_max + 2),2)
    dZ, dN = 0.0, 0.0
