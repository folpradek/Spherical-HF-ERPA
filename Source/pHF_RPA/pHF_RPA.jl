function pHF_RPA(Params::Parameters,Orb::Vector{NOrb},Orb_NN::NNOrb,VNN::NNInt)
    ...
    @time A, B, N, M = pHF_RPA_Allocate(Params,N_nu,Orb_Phonon,Phonon,Particle,Hole,Orb,Orb_NN,VNN)

    # Solve TDA eigenvalue problem and RPA generalized-eigenvalue problem ...
    @time E_TDA, X_TDA, E_RPA, X_RPA, Y_RPA = pHF_RPA_Diagonalize(Params,A,B,N,M,N_nu,Orb_Phonon,Phonon,Particle,Hole,TrOp)
    ...
    HF_RPA_Corr_Energy_Alt(Params,N_nu,N_Particle,Particle,N_Hole,Hole,Orb,Orb_NN,VNN,E_RPA,Y_RPA,Rho_RPA)
    
    HF_RPA_Corr_Energy_Bosonic(Params,N_nu,E_RPA,Y_RPA)
