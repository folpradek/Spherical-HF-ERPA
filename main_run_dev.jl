...
include("Source/MatrixElements/qpH2B_CT.jl")
...
# pHF RPA ...
include("Source/Temp/pHF_RPA/pHF_RPA_Solver.jl")
include("Source/Temp/pHF_RPA/pHF_RPA.jl")
include("Source/Temp/pHF_RPA/pHF_RPA_Allocate.jl")
include("Source/Temp/pHF_RPA/pHF_RPA_Diagonalize.jl")
...
function run_main()
    ...
    CalcParams = Calculation_Parameters(
                ...
                #cV_res = 0.01
                #Pairing = Parameters_Pairing(ScBCS = false, pL0 = -5.0, nL0 = -5.0, pa0 = 0.25, na0 = 0.25, s2 = 1.0, s3 = 1.0),
                )
